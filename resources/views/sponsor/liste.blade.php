...
<head>
    ...
    <link href="<?php echo asset('css/sponsor.css')?>" rel="stylesheet" >
...
<nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
    ...
    <header id="home" class="sarygallary">
        <div class="overlay text-white text-center">
            ...
            <h2 class="display-4 mb-5">@lang('public.Sponsor')</h2>
...
<div class="sary">
@foreach ($sponse as $photo)
<div class="gallery">
  <a> 
    <img src="sponsor/{{$photo->logo_spons}}" alt="Cinque Terre" disabled>
  </a>
  <div class="desc">
  </div>
  <div class="desc">
      <input  value="{{$photo->nom_spons}}" disabled></input>
  </div>
</div>
@endforeach
</div>
