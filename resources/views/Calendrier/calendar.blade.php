...
<head>
    ...
    <link href="<?php echo asset('css/calendrier.css')?>" rel="stylesheet" >
</head>
...
<nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
    ...
    <header id="home" class="sarygallary">
        <div class="overlay text-white text-center">
            ...
            <h2 class="display-4 mb-5">@lang('public.Calendrier')</h2>
            
        </div>
        
    </header>
 <!-- modal -->
@foreach ($calendre as $joeur)
 <div class="form-group">
<input  class="form-control" value="{{$joeur->nom_equi}}" disabled>
<div class="card-body" >  
<form action="" method="POST">
    ...
    <div class="sary" >
      ...
      <input  value="{{$joeur->heure_mat}}" disabled>
      </div>
</form>
</div> 
</div> 
